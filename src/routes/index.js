...
import { deleteSongController, getUsersController, putPlaylistController, usersLoginController, usersRegisterController, } from '../controllers';
import { authUser, checkUsername, validateBody } from '../middlewares';
import { userSchema } from '../models';
const router = Router();
router.post('/register', checkUsername, validateBody(userSchema), usersRegisterController);
