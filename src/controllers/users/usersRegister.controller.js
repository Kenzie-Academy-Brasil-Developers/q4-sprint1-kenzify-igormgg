...
const usersRegisterController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const hashedPassword = yield bcrypt.hash(req.body.password, 10);
    const user = Object.assign(Object.assign({ id: uuidv4() }, req.body), { password: hashedPassword, playlist: {} });
